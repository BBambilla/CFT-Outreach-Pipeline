...
async function run() {
  const { data, error } = await supabase.rpc('exec_sql', { sql: "ALTER TABLE sponsors ADD COLUMN IF NOT EXISTS country text; ALTER TABLE sponsors ADD COLUMN IF NOT EXISTS submission_date date;" });
